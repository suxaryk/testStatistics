 ...
 *
 * @version $Id: DigestUtilsTest.html 891688 2013-12-24 20:49:46Z ggregory $
 */
public class DigestUtilsTest {
    ...
    public void testSha1UpdateWithByteArray(){
        final String d1 = "C'est un homme qui rentre dans un caf�, et plouf";
        final String d2 = "C'est un homme, c'est qu'une t�te, on lui offre un cadeau: 'oh... encore un chapeau!'";
